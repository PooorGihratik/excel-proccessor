from .payment_sheet_register import PaymentSheetRegister
...
class PaymentWorkbookRegister:
    ...
    def get_options(self) -> ProcessorOptions:
    ...
    def register_sections(
        ...
        for section in payments_sections:
            ...
            for payment in section.payment_items:
                ...
                if payment.period.year == self._config.year and section.account in self._registerer_dict.keys():
